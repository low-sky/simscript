...
rootdir = os.path.expanduser("~")+'/SimSuite4/'
rootname = 'Design'
    ...
    for idx,bval in enumerate(bvals):
        ...
        if not os.path.isdir(dirname):
            ...
            with open(dirname+'DrivenTurbulenceCTMHD','a') as template:
                ...
                template.close()
                print(dirname)
    fparams.write('fiducial_table.ascii',format='ascii.fixed_width')
    fparams.write('fiducial_table.csv',format='ascii',delimiter=',')
